...
public class MonsterNamesTester
{
	...
	public static void main(String[] args)
	{
		...
		MonsterNames namesSingleton = MonsterNames.getInstance();
		...
		System.out.println("There are more names:  "
				+ namesSingleton.hasNames());
		for (int i = 0; i < MaxNum; i++)
			System.out.println("\n" + new Monster().toString());
		...
		System.out.println("\nAfter reset, there are more names: "
				+ namesSingleton.hasNames());
		System.out.println("Note identity of nameFirst, nameMid, and nameLast "
				+ "in order to verify last two tests");
		String nameFirst = namesSingleton.getName(0);
		String nameMid = namesSingleton.getName(namesSingleton
				.getCurrentNumberOfNames() / 2);
		String nameLast = namesSingleton.getName(namesSingleton
				.getCurrentNumberOfNames() - 1);
		System.out.println("Current size is:  "
				+ namesSingleton.getCurrentNumberOfNames());
		System.out.println("\nFirst Name is: " + nameFirst + ", at index:  "
				+ namesSingleton.findName(nameFirst) + ", has name:  "
				+ namesSingleton.hasName(nameFirst));
		System.out.println("Middle Name is: " + nameMid + ", at index:  "
				+ namesSingleton.findName(nameMid) + ", has name:  "
				+ namesSingleton.hasName(nameMid));
		System.out.println("Last Name is: " + nameLast + ", at index:  "
				+ namesSingleton.findName(nameLast) + ", has name:  "
		...
		System.out
				.println("\nAfter adding two names, current number of names is:  "
						+ newSize);
		System.out.println(namesSingleton.toString());
		...
		System.out
				.println("Show that the old names that were replaced are gone");
		...
		System.out.println("Is last name in list?  "
				+ namesSingleton.hasName(nameLast));
		// Show that old names have been replaced with new names
		System.out.println("Is Jack in list?  "
				+ namesSingleton.hasName("Jack"));
		System.out.println("Is Jill in list?  "
				+ namesSingleton.hasName("Jill"));
