 ...
 *   Added nextDoubleWrapper
 *   RMR - 2/2012
 */
public class SingleRandom
{
  /**
   * Limits range so no values printed in scientific notation
   */
  ...
  /**
   * Used to generate negative values only
   */
  ...
  /**
   * Returns pseudo-random integer number within interval min to max
   *   inclusive
   * @param min lower limit of random number generated, inclusive
   * @param max upper limit of random number generated, inclusive
   * @return  integer in range min to max inclusive
   */
